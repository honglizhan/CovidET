...
## Update Feb 9, 2023
PushShift Service is Down and users are no longer able to retrieve all submissions prior to November 2022 ([source](https://www.reddit.com/r/pushshift/comments/10utf1d/first_day_trying_to_scrape_reddit_bad_timing/)). If you want to retrieve the original Reddit posts, please email me at [honglizhan@utexas.edu](mailto:honglizhan@utexas.edu), and I will share the dataset containing the original Reddit posts with you. The original dataset is available on Google Drive [here](https://drive.google.com/drive/folders/19TH_rTS2ubwInkPrD9r-GRQz18IyrlmO?usp=share_link).
